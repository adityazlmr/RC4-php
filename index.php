        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="scrollToTop()" data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show">Main</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#about" onclick="$('.navbar-collapse').collapse('hide')">About</a>
                    </li>
                </ul>
            </div>
    ...
    <section id="formCont">
        <div class="container" data-aos="fade-up">
            ...
            <form action="rc4.php" method="post" enctype="multipart/form-data" id="rc4-form">
                <div class="mb-4">
                    <label for="encryptionKey" class="form-label animate__animated animate__fadeInLeftBig">Encryption Key</label>
                    <input type="password" class="form-control" id="encryptionKey" placeholder="minimal 8 karakter" name="encryptionKey" required>
                </div>
                <div class="mb-4">
                    <label for="fileToEncrypt" class="form-label animate__animated animate__fadeInLeftBig">File to Encrypt</label>
                    <input type="file" class="form-control" id="fileToEncrypt" name="fileToEncrypt" required>
                </div>
                <button type="submit" class="btn btn-primary animate__animated animate__fadeInLeftBig" name="encrypt" id="encryptBtn" disabled>Encrypt</button>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <form action="rc4.php" method="post" enctype="multipart/form-data" id="rc4-form">
                <div class="mb-3">
                    <label for="decryptionKey" class="form-label animate__animated animate__fadeInRightBig">Decryption Key</label>
                ...
                <div class="mb-3">
                    <label for="fileToDecrypt" class="form-label animate__animated animate__fadeInRightBig">File to Decrypt</label>
                    <input type="file" class="form-control" id="fileToDecrypt" name="fileToDecrypt" required>
                </div>
                <button type="submit" class="btn btn-primary animate__animated animate__fadeInRightBig" name="decrypt" id="decryptBtn" disabled>Decrypt</button>
            </form>
        </div>
        <script>
        ...
        <div class="container-fluid">
            ...
            <div class="row flex-md-row">
                <div class="col-md-6 mb-5 order-md-1 order-2">
                    <div class="box1 about-content p-5 rounded shadow" data-aos="fade-right" data-aos-anchor-placement="bottom-bottom">
                ...
                <div class="col-md-6 mb-4 order-md-2 order-1">
                    <div class="row flex-md-row">
                        <div class="box2 col-md-12 mb-4">
                            <div class="about-content p-5 rounded shadow" data-aos="fade-left" data-aos-anchor-placement="bottom-bottom">
